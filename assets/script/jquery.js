...
(function (global, factory) {
  ...
  function (window, noGlobal) {
	...
	---------------------------------------------------------------------- */
            ...
            support.attributes = assert(function (
              el
            ) {
              el.className = "i";
        ...
        Expr = Sizzle.selectors = {
          ...
          pseudos: {
            ...
            has: markFunction(function (
              ...
              return function (elem) {
                return (
                  Sizzle(selector, elem).length >
                  0
                );
              };
            }),

            contains: markFunction(function (
              text
            ) {
              text = text.replace(
                runescape,
    ...
    jQuery.fn.extend({
      has: function (target) {
        ...
        return this.filter(function () {
          ...
          for (; i < l; i++) {
            if (
              jQuery.contains(this, targets[i])
            ) {
              return true;
            }
          }
    ...
    function leverageNative(
      ...
      if (!expectSync) {
        if (
          dataPriv.get(el, type) === undefined
        ) {
    ...
    jQuery.extend(jQuery.event, {
      trigger: function (
        ...
        if (
          !onlyHandlers &&
          special.trigger &&
          special.trigger.apply(elem, data) ===
            false
        ) {
          return;
        }
      ...
      ajax: function (url, options) {
        ...
        function done(
          ...
          if (
            ...
            jQuery.inArray("json", s.dataTypes) <
              0
          ) {

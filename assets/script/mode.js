...
// let systemThemeChecked = false;

// $("#magic").on("click", async function() {
//   if (systemThemeChecked) {
//     // Perform the regular theme toggle logic here
//     let theme = "";
//     if (setTheme.classList.contains("light-mode")) {
//       theme = "dark";
...
//     }
//   } else {
//     // Check system theme and update UI accordingly
//     let theme = "";
//     if (await message.alert_Confirm("Do you want to use the system default theme?")) {
